...
export const MOCK_COMMUNITY_POSTS: CommunityPost[] = [
  {
    ...
    afterImage: 'https://images.unsplash.com/photo-1592078615290-033ee584e267?auto=format&fit=crop&w=600&q=80',
    likes: 148,
    comments: [
  ...
  },
  {
    ...
    title: 'Frosted Mason Jar Lanterns',
    description: 'Saved empty glass pasta sauce and jam jars from the trash. After a thorough cleaning, I applied a layer of craft glue and rolled them in coarse Epsom salt to create a beautiful frosted, ice-like texture. Wrapped twine around the necks and added tea lights—the cozy warm glow at night is amazing!',
    material: 'Glass Jar',
    beforeLabel: 'Empty Glass Jars',
    afterLabel: 'Frosted Jar Lanterns',
    beforeColor: 'from-emerald-900/50 to-teal-900/50',
    afterColor: 'from-green-400 to-emerald-600',
    beforeIcon: 'GlassWater',
    afterIcon: 'Sparkles',
    beforeImage: 'https://images.unsplash.com/photo-1535401991746-da3d9055713e?auto=format&fit=crop&w=600&q=80',
    afterImage: 'https://images.unsplash.com/photo-1507652313519-d4e9174996dd?auto=format&fit=crop&w=600&q=80',
    likes: 92,
    comments: [
      { id: 'cc4', username: 'SustainableAlice', text: 'These look incredibly cozy! Does the salt wear off over time?', time: '1 day ago' },
      { id: 'cc5', username: 'RecycleDave', text: 'If you seal them with a light coat of clear acrylic spray, the salt stays perfectly locked in place!', time: '20 hours ago' }
    ],
    date: '2026-06-23'
  },
  {
    ...
    beforeIcon: 'Box',
    afterIcon: 'Cat',
    beforeImage: 'https://images.unsplash.com/photo-1595246140625-573b715d11dc?auto=format&fit=crop&w=600&q=80',
    afterImage: 'https://images.unsplash.com/photo-1592194996308-7b43878e84a6?auto=format&fit=crop&w=600&q=80',
    likes: 205,
    comments: [
